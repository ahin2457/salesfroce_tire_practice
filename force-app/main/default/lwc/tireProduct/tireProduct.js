...
const PERFORMANCE =[{label:'HP', name:'HP', types:'HP'},
...
const COLUMN =[{label:'Product Code', fieldName :'ProductCode', type:'url', typeAttributes:{label:{fieldName :'NameUrl'}}},
{label:'Product Name', fieldName :'productLink', type:'url',typeAttributes:{label:{fieldName :'ProductName'}}},
{label:'Description', fieldName :'Description', type :'text'},
{label:'Description2', fieldName :'Description__c', type :'text'},
{label:'Types', fieldName:'Types__c',type:'Text'},
{label:'Weight', fieldName:'Weight__c',type:'Number'},
{label:'Division', fieldName:'DivisionName__c',type:'Text'},
{label:'Car Type', fieldName:'CarTypeName__c',type:'Text'},
{label:'Brand', fieldName:'Brand__c', type:'Text'},
{label:'Pattern', fieldName:'Pattern__c', type:'Text'},
{label:'SalesPattern', fieldName:'SalesPattern__c', type:'Text'},
{label:'Size', fieldName:'Size__c', type:'Number'},
{label:'Tire Type', fieldName:'TireType__c', type:'Text'},
